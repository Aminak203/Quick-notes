...
<body>
  ...
  <script> document.querySelectorAll(".logoutButton").forEach((button) => {
  ...
  // simulate falling down animation
  updateButtonState(button, "falling");
  setTimeout(() => {
    // redirect to index.php after falling animation finishes
    window.location.href = "index.php";
  }, 1750); // adjust duration of falling animation as needed
});
