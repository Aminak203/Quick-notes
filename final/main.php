...
<?php
    ...
    $stmt->bind_param("sss", $title_encrypted, $note_encrypted, $username);
...
<?php include 'leftcolumn2.php';?>
    ...
    <div class="main-content">
        ...
        <form method="post" action="main.php">
            ...
            <input type="text" id="title" name="title" placeholder="Title" spellcheck="true">

<div id="editor" contenteditable="true" spellcheck="true"></div>

<textarea name="note" id="note" style="display:none" spellcheck="true"></textarea>
...
<div id="translate-wrapper">
    ...
    <!-- <span id="translate-icon"><ion-icon name="swap-horizontal-outline"></ion-icon></span> -->
    <span id="translate-icon"><ion-icon name="language-outline"></ion-icon></span>


    <div id="language-select-wrapper" style="display: none;">
        <select id="language" name="language">
            <option value="ur">Urdu</option>
            <option value="er">English</option>
...
<script>
    ...
    const chunks = sourceText.match(/.{1,5000}/g); // Change the number to the API limit if necessary
    ...
    const processChunk = () => {
        ...
        xhr.send(`sourceText=${encodeURIComponent(chunk)}&language=${language}`);
    };
